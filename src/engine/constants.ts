 ...
 *  - a perfect 82-0 is a genuinely rare event: ~1 in 285 for the casual
 *    top-3 drafter, ~1 in 55 when every pick is one of the two best on the
 ...
 *  the slope sets how rare the OVR-100 ceiling (and so 82-0) is: at 42,
 *  ~1 in 285 for the top-3 drafter, ~1 in 55 for a top-2 drafter, ~1 in 7
